...
import { ForgotPasswordDto } from '../users/dtos/forgotPassword.dto';
import { Otp } from '../users/models/otps.model';
import { UpdatePasswordDto } from '../users/dtos/updatePassword.dto';
import { VerifyOtpDto } from '../users/dtos/verifyOtp.dto';
import { ConfigService } from '@nestjs/config';
import { InjectModel } from '@nestjs/sequelize';
import { SocialLogin } from '../users/models/socialLogin.model';
import { SocialLoginDto } from '../users/dtos/social-login.dto';
import { AUTH_PROVIDERS, EmailTemplates, Role, providerFieldNames } from '../../helpers/constants';
import { HttpService } from '@nestjs/axios';
import { User } from '../users/models/user.model';
import { ChangePasswordDto } from '../users/dtos/changePassword.dto';
import { DeviceTokenDto } from '../users/dtos/deviceToken.dto';
...
export class AuthService {
  ...
  async signIn(body: LoginDto) {
    ...
    await this.usersService.update({ lastLoginAt: new Date() }, user.id);
    return {
      user,
