...
export class FirebaseService {
  ...
  constructor(
    ...
    // const firebaseConfig = require('./../../gotstuck-firebase-adminsdk-u33q4-56a182c8f2.json');
    ...
    if (!admin.apps.length) {
      const firebaseConfig = require('../../galvanic-idiom-421414-firebase-adminsdk-lbl58-25d5053231.json');
      this.firebaseApp = admin.initializeApp({
        credential: admin.credential.cert(firebaseConfig),
      });
    } else {
